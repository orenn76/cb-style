...
import com.cbstyle.common.crudcore.responses.*;
...
public abstract class BaseCrudController<
    ...
    public IdResponse create(@RequestBody @Validated DTO dto) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void update(@PathVariable long id, @RequestBody @Validated DTO dto) {
